...
function kangaroo(x1, v1, x2, v2) {
    ...
    if (v1 === v2) {
        // If both kangaroos have the same speed, they can never meet.
        return "NO";
    }

    const numberOfJumps = (x2 - x1) / (v1 - v2);

    if (Number.isInteger(numberOfJumps) && numberOfJumps >= 0) {
        // If the number of jumps is an integer and non-negative, they will meet.
        return "YES";
    } else {
        return "NO";
    }
